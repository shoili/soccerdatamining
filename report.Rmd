...
The variables with the highest information gain ratio were the betting odds data, as these were most likely fine-tuned by the betting companies. Amongst the non betting data, as shown in Figure XX, the highest were actually the goal differential of the past 10 games. While this may sound logical, since the more goals you score the better chance you have of winning, one may expect certain variables such as shots on goal or shots creation would be more relevant. 
