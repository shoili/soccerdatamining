...
The following table contains the mean accuracy and variance for each method when the calculations were run 100 times. SVMs displayed the highest testing accuracy mean for the 2-class with ~64.5%. Random Forests had the highest accuracy for 3-class predictions, with respective accuracies of ~50.9%. We perform a statistical test (the t-test) to examine whether the means are statistically significantly higher than the means of other models.

For Binary Classification

Name    | Mean Error | Error Variance
------------- | ------------- 
Bradley Terry Model | .536428 | 9.081612e-04
